...
<body> 
 ...
 <form action="exercicio3.php" method="post">
  ...
  <fieldset>
   <legend> Modulo de alteração dos dados </legend>

   <label class="alinha"> ID: </label>
   <input type="text" name="pesquisa-id" placeholder="Forneça o código do produto"> <br>
  ...
  <fieldset>
   <legend> Modulo de exclusão </legend>

   <label class="alinha"> Forneça a quantidade em estoque minima: </label>
   <input type="number" name="exclui-estoque" min="0"> <br>

    <button name="excluir"> Excluir prod. abaixo do mínimo </button>
  </fieldset>
 </form>
