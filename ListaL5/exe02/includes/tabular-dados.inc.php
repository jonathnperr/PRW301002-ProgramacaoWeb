<?php
 ...
 if($numeroLinhasRetornadas == 0)
  {
  echo "<p> Caro usuário, a listagem não foi mostrada porque nenhum produto perecível foi cadastrado! </p>";
  }

 else
  {
  echo "<table>
         <caption> Relação de produtos perecíveis em ordem descrescente pela quantidade de estoque </caption>
         <tr>
          <th> ID </th>
          <th> Preço </th>
          <th> Estoque </th>
