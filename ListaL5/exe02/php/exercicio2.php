...
<body> 
 ...
 <form action="exercicio2.php" method="post">
  <fieldset>
   ...
   <label name="teste"> Classificação do produto: </label> <br><br>
   <input type="radio" name="classificacao" value="Perecível"> <label name="teste2"> Produto perecível </label> <br>

   <input type="radio" name="classificacao" value="Não-perecível"> <label name="teste2"> Produto não-perecível </label> <br><br>

   <label name="teste"> Descrição do produto: </label> <br>
 ...
 <?php
  ...
  //testanto qual operação escolhida
